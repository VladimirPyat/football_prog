...
| Документ | Тема |
|----------|------|
| [USER_GUIDE.md](user/USER_GUIDE.md) | **Участник:** лидерборд, вход, прогнозы, приватность (черновик, скрины — плейсхолдеры) |
| [SUPERVISOR_GUIDE.md](user/SUPERVISOR_GUIDE.md) | **Организатор:** настройки, туры, результаты (черновик, скрины — плейсхолдеры) |
| [assets/SCREENSHOTS.md](user/assets/SCREENSHOTS.md) | Чеклист файлов скриншотов для съёмки |
...
Последняя синхронизация: реорганизация `manuals/` (setup / testing / dev / user), перевод на русский, `README.md` → `INDEX.md`.
