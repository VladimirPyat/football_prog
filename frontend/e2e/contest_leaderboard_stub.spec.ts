...
test.describe("[E2E-LB-STUB-NOT-PUBLISHED]", () => {
  test("leaderboard stub for non-published round", async ({ page }) => {
    ...
    await expect(
      page.getByText("Будет доступно после проверки организатором"),
